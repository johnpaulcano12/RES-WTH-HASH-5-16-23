...
public class settings extends javax.swing.JInternalFrame {
    ...
    // Public constructor
    public Settings() {
        // Initialize the settings frame and other components
    }
    ...
    // Other methods and code for the Settings class
    // ...
}
    ...
    private void initComponents() {
        ...
        jDesktopPane1.add(PM, new org.netbeans.lib.awtextra.AbsoluteConstraints(-5, 2, 200, 150));

        jPanel2.add(jDesktopPane1);
        jDesktopPane1.setBounds(410, 20, 190, 150);
    ...
    Image newImg = img.getScaledInstance(PM.getWidth(), PM.getHeight(), Image.SCALE_SMOOTH);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION){
            ...
            PM.setIcon(ResizeImage(path,null));
            imgPath = path;
        ...
        try{
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/system_db", "root", "");
            String sql = "INSERT INTO images (image, name) VALUES (?,?)";
