...
import static internalPages.puroksTbl.ptbl;
...
public class resident extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jl3.setText("PRINT");
        delete.add(jl3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 50, 30));

        jPanel2.add(delete);
        delete.setBounds(280, 20, 80, 30);
        ...
        jPanel2.add(delete1);
        delete1.setBounds(190, 20, 80, 30);
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        ...
        try{
            res_tbl.print(JTable.PrintMode.NORMAL, header, footer);
        }catch(Exception e){
