...
public class reportsPage extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 200, 30));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 60, 110, 30));

        jButton2.setBackground(new java.awt.Color(69, 193, 255));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 60, 110, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
               reports.print(JTable.PrintMode.NORMAL, header, footer);
        }catch(Exception e){
