...
int res_id[],id;
   ...
   pst1 =db1.connection.prepareStatement("Select res_id,res_id FROM residents");
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(350, 30, 120, 40);
        ...
        jButton4.setFont(new java.awt.Font("Perpetua Titling MT", 1, 13)); // NOI18N
        jButton4.setText("PRINT");
        jButton4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 204, 204), 2));
        ...
        jButton4.setBounds(120, 30, 120, 40);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       MessageFormat header = new MessageFormat("Data of Employees");
        ...
        try{
            ptbl.print(JTable.PrintMode.NORMAL, header, footer);
        }catch(Exception e){
