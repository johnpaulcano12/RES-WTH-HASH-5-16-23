    ...
    private void loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginMouseClicked
         String user = username.getText().toString();
            ...
            try {
                ...
                ResultSet rs = dbc.getData("SELECT * FROM users WHERE u_user = '"+user+"'");
                    if(rs.next()){
                        hashedpass = rs.getString("u_pword");
                         rehashedPassword = PasswordHasher.hashPassword(pass);
                        if(user.equals(rs.getString("u_user")) && hashedpass.equals(rehashedPassword)){
